...
BEGIN
    BEGIN TRY
        ...
        IF @playerID IS NULL
        BEGIN
            RAISERROR ('Error: Player not found.', 0, 1) WITH NOWAIT;
        ...
        BEGIN
            ...
            BEGIN
                RAISERROR ('Error: Player is already on the user''s team.', 0, 1) WITH NOWAIT;
                ROLLBACK TRANSACTION;
                RETURN;
            END
            ...
            RAISERROR ('Player successfully added.', 0, 1) WITH NOWAIT;
        END
        ...
        BEGIN
            ...
            BEGIN
                RAISERROR ('Error: Cannot remove a player who is not on the user''s team.', 0, 1) WITH NOWAIT;
                ROLLBACK TRANSACTION;
                RETURN;
            END
            ...
            RAISERROR ('Player successfully removed.', 0, 1) WITH NOWAIT;
        END
        ...
        BEGIN
            ...
            BEGIN
                RAISERROR ('Error: New player details must be provided for EXCHANGE operation.', 0, 1) WITH NOWAIT;
                ROLLBACK TRANSACTION;
                RETURN;
            END
            ...
            BEGIN
                RAISERROR ('Error: New player not found.', 0, 1) WITH NOWAIT;
                ROLLBACK TRANSACTION;
                RETURN;
            END
            ...
            IF NOT EXISTS (SELECT 1 FROM user_team WHERE email = @email AND player_ID = @playerID)
            BEGIN
                RAISERROR ('Error: Cannot exchange a player who is not on the user''s team.', 0, 1) WITH NOWAIT;
                ROLLBACK TRANSACTION;
                RETURN;
            END
            ...
            BEGIN
                RAISERROR ('Error: The new player is already on the user''s team.', 0, 1) WITH NOWAIT;
                ROLLBACK TRANSACTION;
                RETURN;
            END
            ...
            RAISERROR ('Player successfully exchanged.', 0, 1) WITH NOWAIT;
        END
        ELSE
        BEGIN
            RAISERROR ('Error: Invalid operation. Use INSERT, DELETE, or EXCHANGE.', 0, 1) WITH NOWAIT;
            ROLLBACK TRANSACTION;
            RETURN;
        END
